import { Heart, Mail, MessageSquareText, ShieldCheck } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Create heartfelt messages for loved ones to be delivered in the future or after your passing.
            </p>
            <div className="flex space-x-4">
              <Button variant="ghost" size="icon" className="h-9 w-9 rounded-md bg-muted/50 hover:bg-muted">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/features/encryption" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  End-to-End Encryption
                </Link>
              </li>
              <li>
                <Link href="/features/delivery" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Future Delivery
                </Link>
              </li>
              <li>
                <Link href="/features/formats" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
                  Multiple Content Formats
                </Link>
              </li>
              <li>
                <Link href="/features/notifications" className="text-muted-foreground hover:text-foreground text-sm transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="text-center text-sm text-muted-foreground">
            © {currentYear} Dearly. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
